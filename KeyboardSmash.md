...
They should be keyboard-ordered (and not input-ordered). Characters created withour pressing the SHIFT (asdf etc) should come befoe SHIFTed characters (PI*&" etc.). Each character should be printed once only.
